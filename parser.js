...
var readability = {
    ...
    init: function() {
        ...
        /**
         * Do the customization from Angular
         *
         * set a page template
         * Load angular.min
         *
        **/
        articleContent.innerHTML = readability.to_absolute_links(articleContent.innerHTML);
...
"</head>";
    ...
    /* Part of answer, provided at http://stackoverflow.com/questions/7544550/javascript-regex-to-change-all-relative-urls-to-absolute/7544757#7544757

    These functions will replace all relevant occurences of relative/unknown URLs within a HTML string. URLs are considered relevant if the browser parses the URL, eg by including/linking external content. 

    */

    rel_to_abs: function(url) {
    ...
    to_absolute_links: function(html) {
        ...
        */
        function by(match, group1, group2, group3){
            ...
            * return group1 + "javascript://" + group3; */
            return group1 + readability.rel_to_abs(group2) + group3;
        }
        /*
        @name by
